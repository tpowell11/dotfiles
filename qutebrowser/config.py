...
c.colors.contextmenu.menu.bg = bg2
...
c.colors.downloads.start.fg = bg2

# Color gradient start for download backgrounds.
c.colors.downloads.start.bg = base0D

# Color gradient end for download text.
c.colors.downloads.stop.fg = bg2
...
c.colors.messages.error.fg = bg2
...
c.colors.messages.warning.fg = base0F
...
c.colors.messages.info.border = bg2
...
c.colors.tabs.selected.odd.bg = "#0995ec"

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = base0F

# Background color of selected even tabs.
c.colors.tabs.selected.even.bg = "#0995ec"
